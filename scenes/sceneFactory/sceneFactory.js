/**
 * snatched from the official telegraf docs
 * telegrafjs.org -> API reference -> Stage
 * github.com/telegraf/telegraf/issues/705

 * this resolves my problem of entering the scenes
 * sequently one-by-one, and also using every scene
 * independently later
 */
