...
scene.enter(async ctx => {
    try {
        ...
        throw new Error(`Error in <enter> middleware of <scenes/setters/measures/chest> file --> ${e.message}`);
    }
});
...
scene.on('text', async ctx => {
    try {
        ...
        throw new Error(`Error in <on_text> middleware of <scenes/setters/measures/chest> file --> ${e.message}`);
    }
});
